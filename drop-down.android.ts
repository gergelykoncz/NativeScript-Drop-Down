...
export class DropDown extends DropDownBase {
  ...
  public _realizedItems = [new Map<android.view.View, View>(), new Map<android.view.View, View>()];
      ...
      item.forEach((view) => {
        if (isIncludeHintIn || !(view as any).isHintViewIn) {
          if (
            ...
            const label = view.getViewById<Label>(LABELVIEWID) as any;
