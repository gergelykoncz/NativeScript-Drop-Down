...
import { TextAlignment, TextDecoration, TextTransform } from '@nativescript/core/ui/text-base';
...
export class DropDown extends DropDownBase {
  ...
  public initNativeView() {
    ...
    this._flexToolbarSpace = UIBarButtonItem.alloc().initWithBarButtonSystemItemTargetAction(
      UIBarButtonSystemItem.FlexibleSpace,
      null,
      null
    );
    this._doneTapDelegate = TapHandler.initWithOwner(new WeakRef(this));
    this._doneButton = UIBarButtonItem.alloc().initWithBarButtonSystemItemTargetAction(
      UIBarButtonSystemItem.Done,
      this._doneTapDelegate,
      'tap'
    );
  ...
  private _setPadding(newPadding: { top?: number; right?: number; bottom?: number; left?: number }) {
    ...
    nativeView.padding = { ...padding, ...newPadding };
  }
...
class DropDownListPickerDelegateImpl extends NSObject implements UIPickerViewDelegate {
  ...
  public pickerViewViewForRowForComponentReusingView(
